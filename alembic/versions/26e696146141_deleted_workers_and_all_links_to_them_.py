...
def upgrade() -> None:
    ...
    op.drop_constraint('FK__Tickets__Worker___30592A6F', 'Tickets', schema='Tickets', type_='foreignkey')
    op.drop_constraint('FK__Tickets__Respons__2E70E1FD', 'Tickets', schema='Tickets', type_='foreignkey')
    op.create_foreign_key(None, 'Tickets', 'Users', ['User_ID'], ['ID'], source_schema='Tickets', referent_schema='People')
    op.create_foreign_key(None, 'Tickets', 'Users', ['Responsible_ID'], ['ID'], source_schema='Tickets', referent_schema='People')
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('Tickets', sa.Column('Worker_ID', sa.INTEGER(), autoincrement=False, nullable=False), schema='Tickets')
    op.drop_constraint(None, 'Tickets', schema='Tickets', type_='foreignkey')
    op.drop_constraint(None, 'Tickets', schema='Tickets', type_='foreignkey')
    op.create_foreign_key('FK__Tickets__Respons__2E70E1FD', 'Tickets', 'Workers', ['Responsible_ID'], ['ID'], source_schema='Tickets', referent_schema='People')
    op.create_foreign_key('FK__Tickets__Worker___30592A6F', 'Tickets', 'Workers', ['Worker_ID'], ['ID'], source_schema='Tickets', referent_schema='People')
    ...
    sa.Column('Surname', sa.VARCHAR(length=50, collation='Cyrillic_General_CI_AS'), autoincrement=False, nullable=False),
